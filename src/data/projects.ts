...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    priceFrom: '₹48.0 Lakhs',
    pricePerSqYd: '₹22,000 / sq.yd',
    totalArea: '28 Acres',
    plotSizes: '200, 300 & 450 Sq. Yds',
    lpNumber: 'LP No. 14/2024/CRDA',
    reraId: 'AP RERA P072200388',
    highlights: [
      '2 Mins drive to Vijayawada-Guntur National Highway',
      'Grand 12,000 sq.ft Clubhouse with Swimming Pool',
      'Pre-approved 80% Housing Loan by Top Nationalized Banks',
      'Overhead Fiber Optic & Solar Street Lighting',
      'Adjacent to Premier Educational Institutions & AIIMS'
    ],
    approvals: [
      'CRDA Approved Layout',
      'AP RERA Registered',
      'Bank Loan Facility (SBI, Canara, Bank of Baroda)',
      'Encumbrance-Free Title Certificate'
    ],
    verifiedDocs: [
      {
        id: 'doc-crda-14-2024',
        title: 'CRDA Layout Sanction & Plan Approval',
        type: 'CRDA',
    ...
    specifications: [
      {
        ...
        details: ['Air-Conditioned Gym', 'Swimming Pool & Toddler Pool', 'Banquet Hall for 200 Guests']
      },
      {
        category: 'Eco & Security',
        details: ['Solar Powered Common Area Lighting', 'Rainwater Harvesting Pits every 50 meters', 'RFID Boom Barrier Entry']
      }
    ],
    bankTieUps: ['State Bank of India', 'Canara Bank', 'Bank of Baroda', 'HDFC Bank'],
    googleMapEmbedUrl: 'https://maps.google.com/maps?q=Vijayawada,Andhra+Pradesh&t=&z=13&ie=UTF8&iwloc=&output=embed'
  }
];
