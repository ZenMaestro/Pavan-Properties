        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-10 border-b border-slate-800/80">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li>
                <Link href="/#projects" className="hover:text-emerald-400 transition-colors">Active Verified Projects</Link>
              </li>
              <li>
                <Link href="/photos" className="hover:text-emerald-400 transition-colors">Photos & Site Visit Gallery</Link>
              </li>
              <li>
                <Link href="/about" className="hover:text-emerald-400 transition-colors">About Pavan Kumar (Broker)</Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-emerald-400 transition-colors">Book a Site Visit Slot</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-xs">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href={`tel:${BROKER_INFO.phone}`} className="hover:text-emerald-400 text-white font-semibold">
                  {BROKER_INFO.phone}
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-emerald-400 shrink-0" />
                <a href={`mailto:${BROKER_INFO.email}`} className="hover:text-emerald-400">
                  {BROKER_INFO.email}
                </a>
              </div>
            </div>
