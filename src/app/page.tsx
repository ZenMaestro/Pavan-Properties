  ...
  return (
    <div className="space-y-16 pb-16">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-8 pb-16 overflow-hidden">
        ...
        {/* Ambient Glows */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-gradient-to-tr from-emerald-600/20 via-amber-500/10 to-transparent blur-3xl pointer-events-none rounded-full" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <p className="text-slate-300 text-base sm:text-lg leading-relaxed max-w-2xl font-light">
                We don&apos;t just show glossy 3D renders—we prove legal title with official <strong className="text-amber-300 font-semibold">CRDA Sanction Orders</strong>, <strong className="text-emerald-400 font-semibold">AP RERA Registrations</strong>, and pre-approved bank loans before you inspect a single plot.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4">
                <a
                  href="#book-slot"
                  className="flex items-center gap-2 px-6 py-3.5 rounded-xl bg-gradient-to-r from-emerald-600 via-emerald-500 to-emerald-600 hover:from-emerald-500 hover:to-emerald-400 text-white font-bold text-sm shadow-xl shadow-emerald-950/80 transition-all transform hover:scale-[1.02] active:scale-95"
                >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" id="projects">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 text-xs font-bold text-emerald-400 hover:text-emerald-300 border-b border-emerald-400/40 pb-1 w-fit"
          >
        ...
        <div className="glass-panel rounded-3xl p-8 sm:p-12 border border-slate-800 relative overflow-hidden">
          ...
          <div className="max-w-3xl space-y-4 mb-10">
            ...
            <h2 className="font-display font-extrabold text-2xl sm:text-4xl text-white">
              ...
              <span className="text-emerald-400">Paperwork Before Payment</span>
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-3 relative group hover:border-emerald-500/40 transition-colors">
        ...
        <div className="glass-card rounded-3xl p-8 sm:p-12 border border-slate-800 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-4 relative aspect-[4/5] rounded-2xl overflow-hidden bg-slate-900 border border-slate-800">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-transparent to-transparent flex items-end p-6">
              <div>
                <span className="text-xs text-emerald-400 font-bold tracking-wider uppercase block">Managing Director</span>
          ...
          <div className="lg:col-span-8 space-y-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2">
              ...
              <div className="p-3 rounded-xl bg-slate-900/90 border border-slate-800">
                <span className="text-2xl font-display font-extrabold text-emerald-400 block">₹180Cr+</span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-gradient-to-r from-emerald-950 via-slate-900 to-emerald-950 rounded-3xl p-8 sm:p-12 border border-emerald-500/30 text-center space-y-6 shadow-2xl shadow-emerald-950/50">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <Link
              href="/contact"
              className="flex items-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-emerald-600 via-emerald-500 to-emerald-600 hover:from-emerald-500 hover:to-emerald-400 text-white font-bold text-sm shadow-xl shadow-emerald-950 transition-all transform hover:scale-105"
            >
